    ...
    try {
      ...
      if (args[0] && args[0].length > 0) {
        ...
        const embed = new MessageEmbed()
          ...
          .setTitle("HELP MENU 🔰 Commands Senorita")
          .setDescription(`**[Invite me with __Slash Commands__ Permissions](https://discord.com/oauth2/authorize?client_id=903047974131736620&permissions=70347841&scope=bot), cause all of my Commands are available as Slash Commands too!**\n\n> Check out the [**Dashboard**](https://www.senoritamusic.top) or the [**Website**](https://www.senoritamusic.top)`)
